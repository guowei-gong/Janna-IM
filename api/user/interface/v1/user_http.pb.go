...
const OperationUserUserRegister = "/api.user.interface.v1.User/UserRegister"
...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.POST("/auth/user_register", _User_UserRegister0_HTTP_Handler(srv))
}
...
func (c *UserHTTPClientImpl) UserRegister(ctx context.Context, in *RegisterRequest, opts ...http.CallOption) (*UserReply, error) {
	var out UserReply
